...
let persons = [
    ...
    ['Kawaguchi_Moka', '川口 萌花', 'とんとん担当', '1999年東京都生まれ。デジタルハリウッド大学出身。 現在デジタルハリウッド大学院M2,クリエイティブ会社「PARTY」所属。 高校の頃から映像制作を行い手描きアニメーションと3DCGを駆使した作品を制作。 現在はインスタレーションやメディアアートを中心にインタラクティブな作品制作を行っている。 2018東京国際プロジェクションマッピングアワードVol.3優秀賞受賞、2021デジタルフロンティアグランプリ、ベストアート賞受賞など', 'moka.jpg'],
